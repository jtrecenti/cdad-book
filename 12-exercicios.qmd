...
```{pyodide}
#| exercise: ex_1_1
total_decisoes = total_decisoes_ref.copy() # apenas carregando a variável para o exercício
...
Crie a base de dummies a partir da coluna `juiz` do DataFrame `vivo_filtrado` (criado no Exercício 6). Armazene o resultado em `dummies_juiz`.
